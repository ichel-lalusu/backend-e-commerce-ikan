                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            </a> UBAH DATA KENDARAAN <?=$data->plat_kendaraan?></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                            ...
                            <div class="col-md-6">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <div class="card-title">UBAH DATA KENDARAAN <?=$data->plat_kendaraan?>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" required="" id="jenis_kendaraan" class="form-control" placeholder="Masukkan Jenis Kendaraan" name="jenis_kendaraan" value="<?=$data->jenis_kendaraan?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <div class="input-group">
                                                                <span class="input-group-addon"></span>
                                                                <input type="text" required="" id="plat_kendaraan" class="form-control" placeholder="Masukkan Plat Kendaraan" name="plat_kendaraan" maxlength="8" value="<?=$data->plat_kendaraan?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <div class="input-group">
                                                                <span class="input-group-addon"></span>
                                                                <input type="number" required="" id="kapasitas_kendaraan" class="form-control" placeholder="Masukkan Kapasitas Kendaraan" name="kapasitas_kendaraan" maxlength="8" value="<?=$data->kapasitas_kendaraan?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
