        ...
        <div class="container-fluid">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url("admin/penjual/detail/penjual/" . $data_usaha->id_pj) ?>">Detail Penjual</a></li>
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      ...
                      <div class="row">
                        ...
                        <p class="col-sm-6"><img width="300" src="<?= base_url() . 'foto_usaha/' . $data_usaha->foto_usaha ?>" alt="Foto Penjual <?= ucwords($data_usaha->foto_usaha) ?>"></p>
                      </div>
                      <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                      <!-- <div class="row">
                        <label class="label-control col-sm-6">Jumlah Kapal :</label>
                        <p class="col-sm-6"><?= $data_usaha->jml_kapal; ?></p>
                      </div> -->
                      <!-- <div class="row">
                        <label class="label-control col-sm-6">Kapasitas Kapal :</label>
                        <p class="col-sm-6"><?= $data_usaha->kapasitas_kapal; ?></p>
                      </div> -->
                      <div class="row">
            ...
            <div class="card">
              <div class="card-header" style="background-color: darkblue; color: white">
                ...
                <div class="card-tools">
                  ...
                  <div class="card-body">
                    <h5 class="tx-gray-800 mg-t-50">DATA PRODUK
                      <a href="<?= base_url($menu . '/add') ?>" class="btn btn-info m-l-10 float-right" style="font-size: small; background-color: darkblue; color: white"><i class="fa fa-plus"></i> TAMBAH DATA PRODUK</a></h5>
                                ...
                                if ($data_produk->num_rows() > 0) {
                                  ...
                                  foreach ($data_produk->result() as $produk) {
                                    ...
                                    <tr>
                                      ...
                                      <td class="text-center"><?= ucwords($produk->kategori) ?></td>
                                      ...
                                      <td class="text-center">
                                        <a href="<?= base_url('admin/usaha/editV2/produk/' . $produk->id_produk) ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                                        <button class="btn btn-danger" onclick="confirm<?= $data_usaha->id_usaha ?>()"><i class="fa fa-trash"></i></button>
                                      </td>
                                    </tr>
                                    <?php
                                    $urutan++;
                      ...
                      <div class="card-header" style="background-color: darkgreen; color: white">
                        ...
                        <div class="card-body">
                          <h4 class="tx-gray-800 mg-t-50">DATA KURIR
                            <a href="<?= base_url('admin/Kurir/add') ?>" class="btn btn-info m-l-10 float-right" style="font-size: small; background-color: darkgreen; color: white"><i class="fa fa-plus"></i> TAMBAH DATA KURIR</a></h4>
                            <div class="mt-4 pd-x-30">
                              <div class="row">
                                    ...
                                    if($data_kurir->num_rows() > 0):
                                      ...
                                      foreach ($data_kurir->result() as $key) :
                                        ...
                                        <tr>
                                          ...
                                          <td class="text-center"><a class="btn btn-success" href="<?=base_url('Kurir/edit/').$key->id_kurir?>"><span class="fa fa-edit"></span></a>&nbsp;
                                            <a href="<?=base_url('Kurir/delete/').$key->id_kurir?>" class="btn btn-danger"><span class="fa fa-trash"></span></a></td>
                                          </tr>
                                          <?php
                                          $urutan++;
                                        endforeach;
                            ...
                            <div class="card-header">
                              ...
                              <div class="card-body">
                                <h4 class="tx-gray-800 mg-t-50">DATA KENDARAAN
                                  <a href="<?= base_url('admin/Usaha/add_kendaraan/'.$id_usaha) ?>" class="btn btn-secondary m-l-10 float-right" style="font-size: small"><i class="fa fa-plus"></i> TAMBAH DATA KENDARAAN</a></h4>
                                  <div class="mt-4 pd-x-30">
                                    <div class="row">
                                      <table class="table table-bordered table-hover" id="data-kurir">
                                        <thead>
