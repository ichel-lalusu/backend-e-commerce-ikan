            ...
            <!-- <div class="row"> -->
              <div class="card card-primary">
                <div class="card-header">
                  <div class="card-title">FORM TAMBAH USAHA
                  </div>
                </div>
                      ...
                      <div class="col-md-6">
                        <div class="card" style="padding: 24px">
                          ...
                          <div class="form-group">
                            <label class="form-control-label" for="nama_usaha">Nama Usaha </label>
                            <div>
                              <div class="input-group">
                                <input type="text" id="nama_usaha" name="nama_usaha" required class="form-control input-sm" placeholder="Nama Usaha" autocomplete="off" autofocus="" >
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="foto_ktp" class="form-control-label">Foto Usaha</label>
                            <div class="custom-file">
                              <div class="custom-file form-control">Pilih Foto Usaha
                                <input type="file" id="foto_usaha" class="custom-file-input" name="foto_usaha">
                                <label class="custom-file-label" for="foto_usaha">Pilih Foto</label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-sm-6 col-md-6 col-lg-6">
                              <label class="form-control-label" for="jam_buka">Jam Buka:</label>
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <input type="number" id="noktp_pj" name="noktp_pj" required class="form-control input-sm" placeholder="(16 digit)" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <label class="btn btn-default rdiobox">
                                <input name="jk_pj" value="Laki-laki" type="radio" required>
                                <span>Laki-laki</span>
                              </label>
                              <label class="btn btn-default rdiobox" required>
                        ...
                        <div class="card" style="padding: 24px">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" id="telp_pj" name="telp_pj" required type="number" placeholder="Contoh: 085261641500" autocomplete="off">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div>
                              <label class="btn btn-default rdiobox">
                                <input name="jenis_petani" value="Tawar" type="radio" required>
                                <span>Air Tawar</span>
                              </label>
                              <label class="btn btn-default rdiobox" required>
                                <input name="jenis_petani" value="Laut" type="radio" required>
                                <span>Air Laut</span>
                              </label>
                            </div>
                        <!-- <div>
