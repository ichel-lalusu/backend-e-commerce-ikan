            ...
            <!-- <div class="row"> -->
              <div class="card card-primary">
                <div class="card-header">
                  <div class="card-title">FORM TAMBAH PENJUAL
                  </div>
                </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="form-group">
                              ...
                              <input class="form-control" name="username" type="text" id="username" required="" autocomplete="off" autofocus="" placeholder="Username Penjual">
                            </div>
                            <div class="form-group">
                              <label class="form-control-label" for="password">Password:</label>
                              <input class="form-control" name="password" type="password" id="password" required="" placeholder="Password Penjual" autocomplete="off">
                            </div>
                            <input type="hidden" name="level_user" value="penjual">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                          ...
                          <div class="form-group">
                            ...
                            <div>
                              <div class="input-group">
                                <input type="text" id="nama_pj" name="nama_pj" required class="form-control input-sm" placeholder="Contoh: Riselda Rahma Annisa Lalusu" autocomplete="off" >
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
