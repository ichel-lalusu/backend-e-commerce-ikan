          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><span>Transaksi</span></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <table class="table table-hover table-bordered table-striped dataTable dtr-inline" id="table-init">
                <thead class="thead-colored thead-teal" style="text-align: center">
                  <tr>
                    ...
                    <th class="text-center" width="15%">Nama Pembeli</th>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          echo ucwords($data_pembeli->nama_pb);
                          ?>
                        </td>
                        <td class="text-right">
                        ...
                        <td class="text-center">
                          ...
                          <a href="<?=base_url('admin/Usaha/detail_transaksi/')?><?=$transaksi->id_pemesanan?>" class="btn btn-sm btn-primary">Detail</a>
                          <?php
                          if($data_pengiriman->num_rows() > 0){
                            $pengiriman = $data_pengiriman->row();
