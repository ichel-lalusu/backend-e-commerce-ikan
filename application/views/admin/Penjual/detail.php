    ...
    <div class="content-wrapper">
      ...
      <section class="content">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="row">
                      ...
                      <p class="col-sm-6"><img height="150" src="<?= $url_API . 'foto_ktp_penjual/' . $data_penjual->fotoktp_pj ?>" alt="Foto KTP <?= ucwords($data_penjual->fotoktp_pj) ?>"></p>
                    </div>
                    <div class="row">
        ...
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">DATA USAHA <?= ($data_usaha->nama_usaha) ? "- " . $data_usaha->nama_usaha : ""; ?></h3>
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Collapse">
                <i class="fas fa-minus"></i></button>
              <button type="button" class="btn btn-tool" data-card-widget="remove" data-toggle="tooltip" title="Remove">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <p><?= $data_usaha->jamBuka ?> - <?= $data_usaha->jamTutup ?></p>
                    </td>
                    <!-- <td class="text-center">
                      <p><?= $data_usaha->jml_kapal ?> Kapal, (<?= $data_usaha->kapasitas_kapal ?> Kg)</p>
                    </td> -->
                    <td class="text-center">
                    ...
                    <td class="text-center">
                      <a href="<?= base_url('admin/usaha/edit/' . $data_usaha->id_usaha); ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                      ...
                      <a href="<?= base_url('admin/Usaha/detail/' . $data_usaha->id_usaha); ?>" class="btn btn-primary">Detail</a>
                    </td>
                  </tr>
                  <?php
                  // $no++;
